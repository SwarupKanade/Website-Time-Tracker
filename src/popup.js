...
function displayData(type) {
  ...
  for (var domain in domains) {
    ...
    var re = /[a-z.0-9]+(?=(([.][a-z]+)+))/;
    capDomain = domain.match(re)[0].replace(".", " ").replace(/\b\w/g, l => l.toUpperCase());
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelector("#workstatus").innerHTML = "Working " + work_status.replace(/\b\w/g, l => l.toUpperCase());
  document.querySelector("#workstatus").className = work_status;
